...
def inference(height_airsim_restart_positions):
    ...
    env, env_process = connect_exe_env(height_airsim_restart_positions=height_airsim_restart_positions, env_type='indoor', exe_path="./unreal_envs/easy_maze/Blocks.exe",
